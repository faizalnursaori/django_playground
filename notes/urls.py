...
from .views import dashboard_home_view, dashboard_orders_view, dashboard_profile_view,dashboard_notes_view, notes_detail_view
...
urlpatterns = [
    ...
    path('notes/<str:id>', notes_detail_view, name='notes_detail_view')
]
